...
Then('Check Header Text and URL validation after clicking on Privacy Policy link', (dataTable) => {
...
And('Check the default opened tab section under Privacy Policy page', (dataTable) => {
  dataTable.hashes().forEach(elem => {
...
And('Check the Content in default opened tab under Privacy Policy page', (dataTable) => {
  dataTable.hashes().forEach(elem => {
