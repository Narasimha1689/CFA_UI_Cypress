...
And('Check the default opened tab section under Accessibility page', (dataTable) => {
  dataTable.hashes().forEach(elem => {
...
And('Check the Content in default opened tab under Accessibility page', (dataTable) => {
  dataTable.hashes().forEach(elem => {
