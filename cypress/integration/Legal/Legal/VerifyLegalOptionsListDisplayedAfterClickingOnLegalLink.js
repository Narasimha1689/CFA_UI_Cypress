...
Then('Verify and Check Header Text and URL validation after clicking on Legal link', (dataTable) => {
...
And('Legal options list displayed after clicking on Legal link', (dataTable) => {
  dataTable.hashes().forEach(elem => {
