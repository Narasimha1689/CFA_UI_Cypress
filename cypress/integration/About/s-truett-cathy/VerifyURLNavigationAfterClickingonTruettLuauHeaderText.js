...
Then('Check URL navigation after clicking on The Truett Luau Header Text in s-truett-cathy page', (dataTable) => {
 ...
 And('Verify images in The Truett Luau page', (dataTable) => {
