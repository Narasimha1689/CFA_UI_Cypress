...
Then('Check Local Communities Paragraph Content in Giving Back page', (dataTable) => {
    dataTable.hashes().forEach((elem, index) => {
        cy.get('.wrapper .flex div p:nth-child(2)').eq(index).should('contain',elem.paragraphContent)
    });
 });
